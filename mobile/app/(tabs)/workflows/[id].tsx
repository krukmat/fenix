// Task Mobile P1.4 — FR-300/UC-A4: Workflow detail screen (metadata + DSL viewer + actions)
...
import type { WorkflowStatus } from '../../../src/services/api';
    ...
    <>
      ...
      >
        ...
        <View style={styles.headerRow}>
          <Text variant="titleLarge" style={styles.name} testID="workflow-detail-name">
            {workflow.name}
          </Text>
          <Chip
            compact
            testID="workflow-detail-status"
        ...
        <Text
          ...
          testID="workflow-detail-version"
        >
          {`v${workflow.version}`}
        </Text>
