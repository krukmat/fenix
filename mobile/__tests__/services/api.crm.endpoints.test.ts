...
describe('crmApi endpoint coverage', () => {
  ...
  it('covers Activity, Note, Attachment, and Timeline endpoints', async () => {
    ...
    await crmApi.getActivities('ws-1', { limit: 5, offset: 0 }, { caseId: 'case-1' });
    ...
    await crmApi.getNotes('ws-1', undefined, { entityType: 'case', entityId: 'case-1' });
    ...
    expect(getSpy).toHaveBeenNthCalledWith(2, '/bff/api/v1/activities', { params: { workspace_id: 'ws-1', limit: 5, offset: 0, case_id: 'case-1' } });
    expect(getSpy).toHaveBeenNthCalledWith(3, '/bff/api/v1/activities/act-1', undefined);
    ...
    expect(getSpy).toHaveBeenNthCalledWith(4, '/bff/api/v1/notes', { params: { workspace_id: 'ws-1', limit: 50, offset: 0 } });
    expect(getSpy).toHaveBeenNthCalledWith(5, '/bff/api/v1/notes', { params: { workspace_id: 'ws-1', limit: 50, offset: 0, entity_type: 'case', entity_id: 'case-1' } });
    expect(getSpy).toHaveBeenNthCalledWith(6, '/bff/api/v1/notes/note-1', undefined);
    ...
    expect(getSpy).toHaveBeenNthCalledWith(7, '/bff/api/v1/attachments', { params: { workspace_id: 'ws-1', limit: 50, offset: 0 } });
    expect(getSpy).toHaveBeenNthCalledWith(8, '/bff/api/v1/attachments/att-1', undefined);
    ...
    expect(getSpy).toHaveBeenNthCalledWith(9, '/bff/api/v1/timeline', { params: { workspace_id: 'ws-1', limit: 2, offset: 4 } });
    expect(getSpy).toHaveBeenNthCalledWith(10, '/bff/api/v1/timeline/case/case-1', undefined);
  });
});
