...
describe('api.ts', () => {
  ...
  describe('API wrappers', () => {
    ...
    it('crmApi methods should call expected GET endpoints', async () => {
      ...
      await crmApi.getNotes('ws-1', undefined, { entityType: 'case', entityId: 'c1' });
      ...
      expect(getSpy).toHaveBeenNthCalledWith(6, '/bff/api/v1/notes', { params: { workspace_id: 'ws-1', limit: 50, offset: 0, entity_type: 'case', entity_id: 'c1' } });
      expect(getSpy).toHaveBeenNthCalledWith(7, '/bff/api/v1/accounts/a1');
      expect(getSpy).toHaveBeenNthCalledWith(8, '/bff/api/v1/accounts/a1/contacts', undefined);
      expect(getSpy).toHaveBeenNthCalledWith(9, '/bff/api/v1/deals', { params: { account_id: 'a1', limit: 50 } });
      expect(getSpy).toHaveBeenNthCalledWith(10, '/bff/api/v1/timeline/account/a1', undefined);
      expect(getSpy).toHaveBeenNthCalledWith(11, '/bff/api/v1/deals/d1');
      expect(getSpy).toHaveBeenNthCalledWith(12, '/bff/api/v1/activities', { params: { deal_id: 'd1', limit: 50 } });
      expect(getSpy).toHaveBeenNthCalledWith(13, '/bff/api/v1/cases/c1');
      expect(getSpy).toHaveBeenNthCalledWith(14, '/bff/api/v1/activities', { params: { case_id: 'c1', limit: 50 } });
      expect(getSpy).toHaveBeenNthCalledWith(15, '/bff/api/v1/contacts/ct1');
      expect(getSpy).toHaveBeenNthCalledWith(16, '/bff/api/v1/leads/lead-1');
    });
