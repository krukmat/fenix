...
export const queryKeys = {
  ...
  caseActivities: (workspaceId: string, caseId: string) => ['activities', workspaceId, 'case', caseId] as const,
  ...
  caseNotes: (workspaceId: string, caseId: string) => ['notes', workspaceId, 'case', caseId] as const,
