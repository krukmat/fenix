...
race-stability:
	...
	go test -race -timeout 30m -count=$(RACE_STABILITY_COUNT) \
...
install-hooks:
	...
	@echo "      pre-push will run mobile QA automatically when relevant"
...
help:
	...
	@echo "  make eval              - Run deterministic eval CI gate"
