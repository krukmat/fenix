...
func (s *AttachmentService) Create(ctx context.Context, input CreateAttachmentInput) (*Attachment, error) {
	...
	if timelineErr := createTimelineEvent(ctx, s.querier, input.WorkspaceID, input.EntityType, input.EntityID, input.UploaderID, timelineActionCreated); timelineErr != nil {
...
func (s *AttachmentService) Delete(ctx context.Context, workspaceID, attachmentID string) error {
	...
	if existing != nil {
		if timelineErr := createTimelineEvent(ctx, s.querier, workspaceID, existing.EntityType, existing.EntityID, existing.UploaderID, timelineActionDeleted); timelineErr != nil {
