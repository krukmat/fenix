-- Rollback Migration 028: revert approval status normalization

ALTER TABLE approval_request RENAME TO approval_request_new;
...
FROM approval_request_new;

DROP TABLE approval_request_new;
