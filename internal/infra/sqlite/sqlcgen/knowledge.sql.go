...
type GetKnowledgeItemByEntityRow struct {
	ID                string     `db:"id" json:"id"`
	WorkspaceID       string     `db:"workspace_id" json:"workspaceId"`
	SourceSystem      *string    `db:"source_system" json:"sourceSystem"`
	SourceType        string     `db:"source_type" json:"sourceType"`
...
func (q *Queries) GetKnowledgeItemByEntity(ctx context.Context, arg GetKnowledgeItemByEntityParams) (GetKnowledgeItemByEntityRow, error) {
	row := q.db.QueryRowContext(ctx, getKnowledgeItemByEntity, arg.WorkspaceID, arg.EntityType, arg.EntityID)
	var i GetKnowledgeItemByEntityRow
	err := row.Scan(
		&i.ID,
		&i.WorkspaceID,
		&i.SourceSystem,
...
type GetKnowledgeItemByIDRow struct {
	ID                string     `db:"id" json:"id"`
	WorkspaceID       string     `db:"workspace_id" json:"workspaceId"`
	SourceSystem      *string    `db:"source_system" json:"sourceSystem"`
	SourceType        string     `db:"source_type" json:"sourceType"`
...
func (q *Queries) GetKnowledgeItemByID(ctx context.Context, arg GetKnowledgeItemByIDParams) (GetKnowledgeItemByIDRow, error) {
	row := q.db.QueryRowContext(ctx, getKnowledgeItemByID, arg.ID, arg.WorkspaceID)
	var i GetKnowledgeItemByIDRow
	err := row.Scan(
		&i.ID,
		&i.WorkspaceID,
		&i.SourceSystem,
...
type ListKnowledgeItemsByEntityRow struct {
	ID                string     `db:"id" json:"id"`
	WorkspaceID       string     `db:"workspace_id" json:"workspaceId"`
	SourceSystem      *string    `db:"source_system" json:"sourceSystem"`
	SourceType        string     `db:"source_type" json:"sourceType"`
...
func (q *Queries) ListKnowledgeItemsByEntity(ctx context.Context, arg ListKnowledgeItemsByEntityParams) ([]ListKnowledgeItemsByEntityRow, error) {
	...
	defer rows.Close()
	items := []ListKnowledgeItemsByEntityRow{}
	for rows.Next() {
		var i ListKnowledgeItemsByEntityRow
		if err := rows.Scan(
			&i.ID,
			&i.WorkspaceID,
			&i.SourceSystem,
...
type ListKnowledgeItemsByWorkspaceRow struct {
	ID                string     `db:"id" json:"id"`
	WorkspaceID       string     `db:"workspace_id" json:"workspaceId"`
	SourceSystem      *string    `db:"source_system" json:"sourceSystem"`
	SourceType        string     `db:"source_type" json:"sourceType"`
...
func (q *Queries) ListKnowledgeItemsByWorkspace(ctx context.Context, arg ListKnowledgeItemsByWorkspaceParams) ([]ListKnowledgeItemsByWorkspaceRow, error) {
	rows, err := q.db.QueryContext(ctx, listKnowledgeItemsByWorkspace, arg.WorkspaceID, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []ListKnowledgeItemsByWorkspaceRow{}
	for rows.Next() {
		var i ListKnowledgeItemsByWorkspaceRow
		if err := rows.Scan(
			&i.ID,
			&i.WorkspaceID,
			&i.SourceSystem,
