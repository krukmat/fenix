...
type QuotaPolicy struct {
	ID              string    `db:"id" json:"id"`
	WorkspaceID     string    `db:"workspace_id" json:"workspaceId"`
	PolicyType      string    `db:"policy_type" json:"policyType"`
	ScopeType       string    `db:"scope_type" json:"scopeType"`
	ScopeID         *string   `db:"scope_id" json:"scopeId"`
	MetricName      string    `db:"metric_name" json:"metricName"`
	LimitValue      float64   `db:"limit_value" json:"limitValue"`
	ResetPeriod     string    `db:"reset_period" json:"resetPeriod"`
	EnforcementMode string    `db:"enforcement_mode" json:"enforcementMode"`
	IsActive        int64     `db:"is_active" json:"isActive"`
	CreatedAt       time.Time `db:"created_at" json:"createdAt"`
	UpdatedAt       time.Time `db:"updated_at" json:"updatedAt"`
}
...
type QuotaState struct {
	ID            string     `db:"id" json:"id"`
	WorkspaceID   string     `db:"workspace_id" json:"workspaceId"`
	QuotaPolicyID string     `db:"quota_policy_id" json:"quotaPolicyId"`
...
type ScheduledJob struct {
	...
	Payload     json.RawMessage `db:"payload" json:"payload"`
	ExecuteAt   time.Time       `db:"execute_at" json:"executeAt"`
	Status      string          `db:"status" json:"status"`
...
type UsageEvent struct {
	...
	InputUnits    int64     `db:"input_units" json:"inputUnits"`
	OutputUnits   int64     `db:"output_units" json:"outputUnits"`
