...
type Querier interface {
	...
	DismissSignal(ctx context.Context, arg DismissSignalParams) (Signal, error)
	...
	GetActiveWorkflowByName(ctx context.Context, arg GetActiveWorkflowByNameParams) (Workflow, error)
	...
	GetKnowledgeItemByEntity(ctx context.Context, arg GetKnowledgeItemByEntityParams) (GetKnowledgeItemByEntityRow, error)
	// Task 2.1/2.2: Retrieve a single knowledge item (excludes soft-deleted)
	GetKnowledgeItemByID(ctx context.Context, arg GetKnowledgeItemByIDParams) (GetKnowledgeItemByIDRow, error)
	...
	GetSignalByID(ctx context.Context, arg GetSignalByIDParams) (Signal, error)
	...
	GetWorkflowByNameAndVersion(ctx context.Context, arg GetWorkflowByNameAndVersionParams) (Workflow, error)
	...
	ListApprovalRequestsByIDs(ctx context.Context, ids []string) ([]ApprovalRequest, error)
	...
	ListAuditEventsByTraceID(ctx context.Context, traceID *string) ([]AuditEvent, error)
	...
	ListKnowledgeItemsByEntity(ctx context.Context, arg ListKnowledgeItemsByEntityParams) ([]ListKnowledgeItemsByEntityRow, error)
	// Task 2.2: List all knowledge items for a workspace (paginated)
	ListKnowledgeItemsByWorkspace(ctx context.Context, arg ListKnowledgeItemsByWorkspaceParams) ([]ListKnowledgeItemsByWorkspaceRow, error)
	...
	ListSignalsByEntity(ctx context.Context, arg ListSignalsByEntityParams) ([]Signal, error)
	ListSignalsByStatus(ctx context.Context, arg ListSignalsByStatusParams) ([]Signal, error)
	ListSignalsByWorkspace(ctx context.Context, workspaceID string) ([]Signal, error)
	...
	ListWorkflowVersionsByName(ctx context.Context, arg ListWorkflowVersionsByNameParams) ([]Workflow, error)
	ListWorkflowsByStatus(ctx context.Context, arg ListWorkflowsByStatusParams) ([]Workflow, error)
	ListWorkflowsByWorkspace(ctx context.Context, workspaceID string) ([]Workflow, error)
