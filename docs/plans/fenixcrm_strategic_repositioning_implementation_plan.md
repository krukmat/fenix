...
3. approval and runtime outcome contracts are normalized to the target public model, but support hardening and usage-facing APIs still depend on the next wave
4. the evidence pack contract is locked across evidence and copilot surfaces, while support and sales still need their wedge-specific closure work
